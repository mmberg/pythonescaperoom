...
class DerFluchdesPharao(EscapeRoom):
    ...
    #def create_level1(self):
        ...
        #     "<b>"+mythos+"</b>",
        #     "<br></br>",
        #     "In einer anderen Ecke siehst du folgende Listen: ",
        #     zahl_in_worten,
        #     code
        #     ]
        # hints = [
    ...
    def bauplan(self,rohbau):
        ...
        """ #Durcheinander geratener Bauplan zusammen bauen 
        for i in range(len(rohbau)):
            print(rohbau[i])
